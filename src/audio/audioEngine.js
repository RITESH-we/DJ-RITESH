...
class DJAudioEngine {
  ...
  createDemoTracks() {
    ...
    return [
      ...
      {
        id: 'demo-5',
        title: 'Sahara Golden Sunset',
        artist: 'Desert Mirage',
        bpm: 122,
        key: '10B / D',
        genre: 'Organic House',
        duration: 300,
        audioBuffer: this._generateSynthTrack(122, 300, 'house'),
      },
      {
        id: 'demo-6',
        title: 'Berlin Underground 4AM',
        artist: 'Vault 99',
        bpm: 134,
        key: '1A / G#m',
        genre: 'Peak-Time Techno',
        duration: 300,
        audioBuffer: this._generateSynthTrack(134, 300, 'deepTech'),
      },
      {
        id: 'demo-7',
        title: 'Miami Skyline Drive',
        artist: 'Neon Vice',
        bpm: 126,
        key: '7A / Dm',
        genre: 'Synthwave Club',
        duration: 300,
        audioBuffer: this._generateSynthTrack(126, 300, 'house'),
      },
      {
        id: 'demo-8',
        title: 'Mumbai Electric Dhol',
        artist: 'Raga Beats',
        bpm: 126,
        key: '6A / Gm',
        genre: 'Desi EDM',
        duration: 300,
        audioBuffer: this._generateSynthTrack(126, 300, 'bass'),
      },
    ];
  }
